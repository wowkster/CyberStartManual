...
By looking at the HTML, we can see that all the links have a [data attribute](#relevant-resources) called `data-sd` (the "sd" here stands for [subdomain](#relevant-resources)). Some of the links also have an attribute called `data-id`. 
